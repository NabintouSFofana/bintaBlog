...
<!-- main content start -->
<div class="mainwrap blog <?php if(is_front_page()) echo 'home' ?>  <?php if(isset($pmc_data['use_grid'])) echo 'pmc-grid' ?>">
	<div class="main clearfix">
		...
		<div class="content blog">
			...
			if ( has_post_format( 'quote' , get_the_id())){ $count_posts-- ; continue ;}
			...
			<div class="link-category">
				<div class="blogpostcategory <?php if ($count_posts % 3 == 0) {echo 'last'; } ?>">
				<?php get_template_part('includes/boxes/loopBlog_gridLink'); ?>								
				</div>
			</div>
			...
			<div class="quote-category">
				<div class="blogpostcategory <?php if ($count_posts % 3 == 0) {echo 'last'; } ?>">				
					<?php get_template_part('includes/boxes/loopBlog_gridQuote'); ?>								
				</div>
			</div>
