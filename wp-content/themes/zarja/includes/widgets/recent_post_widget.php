...
class recent_posts extends WP_Widget {
	function __construct() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'recent_posts', 'description' => 'Displays the post image and title.'.'zarja' );
		/* Create the widget. */
		parent::__construct( 'recent_posts-widget','Zarja - Premium Recent Posts', $widget_ops, '' );
	}
