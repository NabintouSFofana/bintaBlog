...
class category_posts extends WP_Widget {
	function __construct() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'category_posts', 'description' => 'Displays the post image and excerpt from a selected category **Does not work on singlepost sidebar**'.'zarja' );
		/* Create the widget. */
		parent::__construct( 'category_posts-widget', 'Zarja - Premium Popular Posts', $widget_ops, '' );
	}
