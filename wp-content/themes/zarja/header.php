	...
	<!-- start header -->
			...
			<?php 
				...
				<header>
					...
					<div id="logo">
					<?php $logo = esc_url($pmc_data['logo']); ?>
					...
					if(function_exists( 'putRevSlider')){					
						if(isset($pmc_data['rev_slider']) && $pmc_data['rev_slider'] != ''){ ?>
							<div id="zarjaSlider">
								<?php putRevSlider(esc_attr($pmc_data['rev_slider']),"homepage") ?>
							</div>
						<?php } ?>
					<?php } ?>
					<?php 
						...
						<div class="block1">
							<a href="<?php echo esc_url($pmc_data['block1_link1']) ?>" title="Image">
								...
								<div class="block1_all_text">
									...
									<div class="block1_text">
										<p><?php echo esc_html(stripslashes($pmc_data['block1_text1'])) ?></p>
									</div>
							...
							<a href="<?php echo esc_url($pmc_data['block1_link2']) ?>" title="Image" >
								...
								<div class="block1_all_text">
									...
									<div class="block1_text">
										<p><?php echo esc_html(stripslashes($pmc_data['block1_text2'])) ?></p>
									</div>
							...
							<a href="<?php echo esc_url($pmc_data['block1_link3']) ?>" title="Image" >
								...
								<div class="block1_all_text">
									...
									<div class="block1_text">
										<p><?php echo esc_html(stripslashes($pmc_data['block1_text3'])) ?></p>
									</div>
