...
class ReduxFramework_textarea extends ReduxFramework {
    ...
    */
    ...
    function render() {
        ...
        ?><textarea name="<?php echo esc_attr($this->field['name'] . $this->field['name_suffix']); ?>" id="<?php echo esc_attr($this->field['id']); ?>-textarea" placeholder="<?php echo esc_attr($this->field['placeholder']); ?>" class="large-text <?php echo esc_attr($this->field['class']); ?>" rows="<?php echo esc_attr($this->field['rows']); ?>"><?php echo htmlspecialchars_decode($this->value); ?></textarea><?php
