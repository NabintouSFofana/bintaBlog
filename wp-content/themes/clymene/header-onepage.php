...
<body <?php body_class(); ?>>
	<div class="header-top not-hide">

		<header class="cd-main-header">
			<a class="cd-logo animsition-link" href="<?php echo esc_url(home_url('/')); ?>"><img src="<?php echo esc_url($clymene_option['logo']['url']); ?>" alt=""></a>
		...
		<nav class="cd-nav">				
			<?php
			 $onepagemenu = array(
					...
					'container_class' => '',
					'container_id'    => '',
					'menu_class'      => 'cd-primary-nav is-fixed onepage',
