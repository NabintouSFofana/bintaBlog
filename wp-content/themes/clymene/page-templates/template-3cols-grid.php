<?php
/**
 * Template Name: Portfolio Grid 3 Cols
 */
	...
	<section class="section white-section section-padding-top-bottom">
		...
		<div class="container">
			...
			<div id="projects-grid">
				<?php if(have_posts()) : ?>	
				<?php 
					if($clymene_option['number_show']){ $num = $clymene_option['number_show']; }else{ $num = 9; }
					$args = array(    
						'paged' => $paged,
						'post_type' => 'portfolio',
						'posts_per_page' => $num,
				...
				?> 		
					...
					<div class="four columns <?php echo esc_attr($cate_slug); ?>">
