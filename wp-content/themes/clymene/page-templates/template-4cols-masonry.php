<?php
/**
 * Template Name: Portfolio Masonry 4 Cols
 */
	...
	<section class="section white-section section-padding-top-bottom">
		...
		<div class="projects-wrapper">
			...
			?> 		
				...
				<div class="portfolio-box-3 qvart-box-3 <?php echo esc_attr($cate_slug); ?>">
					...
					<a href="<?php the_permalink(); ?>"><div class="mask-2"></div></a>
					<h6><?php the_title(); ?></h6>
