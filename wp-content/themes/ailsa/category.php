...
<div class="aisa-containerWrap <?php echo esc_attr($ailsa_parent_class); ?>">
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <?php if (category_description()) {
          $description_class = 'have-cat-description';
        } else {
          $description_class = 'dhave-cat-description';
        } ?>
        <div class="aisa-categoryBar <?php echo esc_attr($description_class); ?>">
          <?php echo esc_html__( 'Posts for', 'ailsa' ); ?>
          <mark class="dark">
        ...
        <?php if (category_description()) { ?>
        <div class="aisa-category-description"><?php echo category_description(); ?></div>
        <?php } ?>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <?php if ($ailsa_sidebar_position === 'sidebar-left' && $ailsa_sidebar_position !== 'sidebar-hide') { get_sidebar(); } ?>
      <!-- Content Col Start -->
             ...
             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
               <div class="<?php echo esc_attr($ailsa_blog_style); ?>">
                  ...
                  if ( have_posts() ) :
                    ...
                    $ailsa_count_all_post = $ailsa_count_all_post - 1;
                    $ailsa_count = 1; $ailsa_showposts = 0;
                    /* Start the Loop */
                    while ( have_posts() ) : the_post();
                      if($ailsa_count === 1){
                        echo '<div class="row aisa-fullgrid"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">';
                          get_template_part( 'layouts/post/content', 'category');
                        echo '</div></div>';
                      } else {
                        $ailsa_showposts++;
                        if ( $ailsa_grid_number != 1) {
                          if( $ailsa_showposts === 1 ){
                            echo '<div class="row">';
                          }else if(( $ailsa_showposts % $ailsa_grid_number ) === 1 ){
                            echo '<div class="row">';
                          }
                        ...
                        if ( $ailsa_grid_number != 1) {
                          echo '</div>';
                          if((($ailsa_showposts % $ailsa_grid_number) === 0) || ($ailsa_showposts === ($ailsa_count_all_post))){
                            echo '</div>';
                          }
                        }
                      }
      ...
      <?php if ($ailsa_sidebar_position !== 'sidebar-hide') { get_sidebar(); } ?>
