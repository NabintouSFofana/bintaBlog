 ...
 */
require_once AILSA_FRAMEWORK . '/plugins/notify/class-tgm-plugin-activation.php';

add_action( 'tgmpa_register', 'ailsa_register_required_plugins' );
 ...
 */
function ailsa_register_required_plugins() {
	/*
    ...
    array(
	    'name'					=> 'Ailsa Core',
	    'slug'     			=> 'ailsa-core',
	    'source'				=> 'https://victorthemes.com/plugins/ailsa-core.zip',
	    'required'			=> true,
