...
$post_taxonomy_arrays = array(__('Category','new-blog'),__('Date','new-blog'),__('Comment','new-blog'),__('Tag','new-blog'),__('ReadMore','new-blog'),__('UseBlankImage','new-blog'),__('TimeAgo','new-blog'),__('Wordcount','new-blog'));
foreach ($post_taxonomy_arrays as  $post_taxonomy) {
