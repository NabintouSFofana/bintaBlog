  ...
  $options[] = array(
    ...
    'fields' => array(
      ...
      array(
        'type'             => 'notice',
        'class'            => 'info cs-seese-heading',
        'content'          => esc_html__('General', 'seese'),
      ),
      array(
        'id'               => 'theme_img_resizer',
        'type'             => 'switcher',
        'title'            => esc_html__('Disable Image Resizer?', 'seese'),
        'info'             => __('Turn on if you don\'t want image resizer.', 'seese'),
      ),
      ...
      array(
        ...
        'fields' => array(
          ...
          array(
            ...
            'options'      => array(
                '1/12'  => esc_html__('1 Column', 'seese'),
                '1/5'   => esc_html__('2 Columns', 'seese'),
                '1/4'   => esc_html__('3 Columns', 'seese'),
                '1/3'   => esc_html__('4 Columns', 'seese'),
                '5/12'  => esc_html__('5 Columns', 'seese'),
                '1/2'   => esc_html__('6 Columns', 'seese'),
                '7/12'  => esc_html__('7 Columns', 'seese'),
                '2/3'   => esc_html__('8 Columns', 'seese'),
                '3/4'   => esc_html__('9 Columns', 'seese'),
                '5/6'   => esc_html__('10 Columns', 'seese'),
                '11/12' => esc_html__('11 Columns', 'seese'),
                '12/12' => esc_html__('12 Columns', 'seese'),
              ),
