...
if ( ! function_exists( 'seese_scripts_styles' ) ) {
  function seese_scripts_styles() {
    ...
    wp_enqueue_style( 'bootstrap-css', SEESE_CSS .'/bootstrap.min.css', array(), '4.5.3', 'all' );
    ...
    // Scripts
    wp_enqueue_script( 'popper', SEESE_SCRIPTS . '/popper.min.js', array( 'jquery' ), SEESE_VERSION, true );
    wp_enqueue_script( 'bootstrap-js', SEESE_SCRIPTS . '/bootstrap.min.js', array( 'jquery' ), '4.5.3', true );
