  ...
  function seese_count_widgets( $sidebar_id ) {
		...
		if ( isset( $sidebars_widgets_count[ $sidebar_id ] ) ) :
		  ...
		  if ( $widget_count % 4 == 0 || $widget_count > 6 ) :
		    $widget_classes .= ' col-lg-3 col-md-3 col-sm-6 col-12';
  ...
  function seese_footer_widgets() {
    ...
    if( $footer_widget_layout ) {
      ...
      switch ( $footer_widget_layout ) {
        ...
        case 4: $widget = array('piece' => 4, 'class' => 'col-lg-3 col-md-3 col-sm-6 col-12'); break;
        case 5: $widget = array('piece' => 3, 'class' => 'col-lg-3 col-md-3 col-sm-6 col-12', 'layout' => 'col-lg-6 col-md-6 col-sm-6 col-xs-12', 'queue' => 1); break;
        case 6: $widget = array('piece' => 3, 'class' => 'col-lg-3 col-md-3 col-sm-6 col-12', 'layout' => 'col-lg-6 col-md-6 col-sm-6 col-xs-12', 'queue' => 2); break;
        case 7: $widget = array('piece' => 3, 'class' => 'col-lg-3 col-md-3 col-sm-6 col-12', 'layout' => 'col-lg-6 col-md-6 col-sm-6 col-xs-12', 'queue' => 3); break;
        ...
        default : $widget = array('piece' => 4, 'class' => 'col-lg-3 col-md-3 col-sm-6 col-12'); break;
      }
    ...
    if ( class_exists('WooCommerce') && ( ( is_product_category() || is_product_tag() ) ) ) {
      ...
      if($custom_title) {
        ...
        if ( is_day() ) {
          ...
          esc_html_e( 'Shop', 'seese' );
        } else {
          esc_html_e( 'Archives', 'seese' );
        }
      } else {
        the_title();
      }
...
if ( ! function_exists( 'seese_wp_share_option' ) ) {
  function seese_wp_share_option() {
    ...
    <div class="seese-share">
      ...
      <ul>
        <li>
          <a href="//twitter.com/intent/tweet?text=<?php print(urlencode($title)); ?>&url=<?php print(urlencode($page_url)); ?>" class="icon-fa-twitter" data-toggle="tooltip" data-placement="top" title="<?php echo esc_attr( $share_on_text .' '); echo esc_attr('Twitter', 'seese'); ?>" target="_blank"><i class="fa fa-twitter"></i></a>
        </li>
        <li>
          <a href="//www.facebook.com/sharer/sharer.php?u=<?php print(urlencode($page_url)); ?>&amp;t=<?php print(urlencode($title)); ?>" class="icon-fa-facebook" data-toggle="tooltip" data-placement="top" title="<?php echo esc_attr( $share_on_text .' '); echo esc_attr('Facebook', 'seese'); ?>" target="_blank"><i class="fa fa-facebook"></i></a>
        </li>
        <li>
          <a href="//pinterest.com/pin/create/button/?url=<?php print(urlencode($page_url)); ?>&amp;description=<?php print(urlencode($title)); ?>" class="icon-fa-pinterest" data-toggle="tooltip" data-placement="top" title="<?php echo esc_attr( $share_on_text .' '); echo esc_attr('Pinterest', 'seese'); ?>" target="_blank"><i class="fa fa-pinterest-p"></i></a>
        </li>
      </ul>
    </div>
<?php
