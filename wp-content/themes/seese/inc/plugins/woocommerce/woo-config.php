...
if ( class_exists( 'WooCommerce' ) ) {
  ...
  if (!function_exists('seese_product_cat_title_open')) {
		function seese_product_cat_title_open() {
			echo '</div><div class="seese-product-cnt"><a href="'. get_the_permalink() .'"><div class="seese-product-text">';
		}
	}
  ...
  if ( ! function_exists('seese_add_custom_badge') ) {
	...
	if (!function_exists('seese_meta_wrap_open')) {
	  function seese_meta_wrap_open() {
	      echo '<div class="seese-product-cnt"><a href="'. get_the_permalink() .'"><div class="seese-product-text">';
	  }
	}
  ...
  if (!$woo_single_related) {
	...
	add_filter( 'woocommerce_reviews_title', 'remove_product_reviews_heading' );
	...
	if ( ! function_exists( 'seese_wp_single_product_share_option' ) ) {
	  function seese_wp_single_product_share_option() {
	    ...
	    if ( !in_array( 'twitter', $share_hide ) ) :
	        $output.= '<li><a href="//twitter.com/intent/tweet?text='.urlencode($title).'&url='.urlencode($page_url).'" class="icon-fa-twitter" data-toggle="tooltip" data-placement="top" title="'.esc_attr($share_on_text).' '.esc_html__('Twitter', 'seese').'" target="_blank"><i class="fa fa-twitter"></i></a></li>';
	    endif;
	    if ( !in_array( 'facebook', $share_hide ) ) :
	        $output.= '<li><a href="//www.facebook.com/sharer/sharer.php?u='.urlencode($page_url).'&amp;t='.urlencode($title).'" class="icon-fa-facebook" data-toggle="tooltip" data-placement="top" title="'.esc_attr($share_on_text).' '.esc_html__('Facebook', 'seese').'" target="_blank"><i class="fa fa-facebook"></i></a></li>';
	    endif;
	    if ( !in_array( 'linkedin', $share_hide ) ) :
	        $output.= '<li><a href="//www.linkedin.com/shareArticle?mini=true&amp;url='.urlencode($page_url).'&amp;title='.urlencode($title).'" class="icon-fa-linkedin" data-toggle="tooltip" data-placement="top" title="'.esc_attr($share_on_text).' '.esc_html__('Linkedin', 'seese').'" target="_blank"><i class="fa fa-linkedin"></i></a></li>';
	    endif;
	    if ( !in_array( 'pinterest', $share_hide ) ) :
	        $output.= '<li><a href="//pinterest.com/pin/create/button/?url='.urlencode($page_url).'&amp;description='.urlencode($title).'" class="icon-fa-pinterest" data-toggle="tooltip" data-placement="top" title="'.esc_attr($share_on_text).' '.esc_html__('Pinterest', 'seese').'" target="_blank"><i class="fa fa-pinterest-p"></i></a></li>';
	    endif;
	    $output.= '</ul></div></div>';
	    echo $output;
	  }
