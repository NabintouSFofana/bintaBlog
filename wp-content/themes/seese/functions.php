...
define('SEESE_NAME', $seese_theme->get( 'Name' ));
define('SEESE_VERSION', $seese_theme->get( 'Version' ));
define('SEESE_BRAND_URL', $seese_theme->get( 'AuthorURI' ));
define('SEESE_BRAND_NAME', $seese_theme->get( 'Author' ));
