...
if ( $related_products ) :
    ...
    if($woo_related_load_style === 'slider') {
        ...
        $woo_related_col_number  = $woocommerce_loop['columns'];
        ...
        <section class="related products container">
            ...
            <?php
            $heading = apply_filters( 'woocommerce_product_related_products_heading', __( 'Related products', 'seese' ) );
            ...
            <ul class="products seese-related-product-slider owl-carousel" <?php echo esc_attr($data_attr_value); ?>>             
    ...
    <?php } else {  // Custom Changes Ends ?>
        ...
        <section class="related products container <?php echo esc_attr($shop_col_class) ?>"><!-- custom class 'container' and $shop_col_class added -->
