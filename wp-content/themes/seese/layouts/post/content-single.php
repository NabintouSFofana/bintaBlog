        ...
        <div class="seese-gallery seese-featured">
          ...
          foreach ( $ids as $id ) {
            ...
            if( ($count === 1) || (($count % 2) === 1) ) {
              ...
              if( ($count_img === 1) || (($row_number % 2) === 1 && ($row_number === $row_img)) ){
                ...
                if( ($row_img === 1) || (($row_img % 2) === 1) ) {
                    ...
                    if (class_exists('Aq_Resize')) {
                      $featured_img = aq_resize( $attachment[0], '575', '320', true );
                    } else {
                      $featured_img = $attachment[0];
                    }
                    echo '<a href='.$attachment[0].'><img src="'. esc_url($featured_img) .'" alt="'. esc_attr($alt) .'" /></a></li>';
                  } else {
                    if (class_exists('Aq_Resize')) {
                      $featured_img = aq_resize( $attachment[0], '380', '230', true );
                    } else {
                      $featured_img = $attachment[0];
                    }
              ...
              if( ($row_img === 1) || (($row_img % 2) === 1) ) {
                if (class_exists('Aq_Resize')) {
                  $featured_img = aq_resize( $attachment[0], '250', '320', true );
                } else {
                  $featured_img = $attachment[0];
                }
                ...
                if (class_exists('Aq_Resize')) {
                  $featured_img = aq_resize( $attachment[0], '445', '230', true );
                } else {
                  $featured_img = $attachment[0];
                }
