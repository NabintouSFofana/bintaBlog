...
if ($seese_meta) {
  ...
  if($logo_column === '1/12'){
    $logo_col_class = 'col-lg-1 col-md-1 col-sm-1 col-6 seese-logo-actual';
  } elseif($logo_column === '1/5'){
    $logo_col_class = 'col-lg-2 col-md-2 col-sm-6 col-6 seese-logo-actual';
  } elseif($logo_column === '1/4'){
    $logo_col_class = 'col-lg-3 col-md-3 col-sm-6 col-6 seese-logo-actual';
  } elseif($logo_column === '1/3'){
    $logo_col_class = 'col-lg-4 col-md-4 col-sm-6 col-6 seese-logo-actual';
  } elseif($logo_column === '5/12'){
    $logo_col_class = 'col-lg-5 col-md-5 col-sm-6 col-6 seese-logo-actual';
  } elseif($logo_column === '1/2'){
    $logo_col_class = 'col-lg-6 col-md-6 col-sm-6 col-6 seese-logo-actual';
  } elseif($logo_column === '7/12'){
    $logo_col_class = 'col-lg-7 col-md-7 col-sm-7 col-6 seese-logo-actual';
  } elseif($logo_column === '2/3'){
    $logo_col_class = 'col-lg-8 col-md-8 col-sm-8 col-6 seese-logo-actual';
  } elseif($logo_column === '3/4'){
    $logo_col_class = 'col-lg-9 col-md-9 col-sm-9 col-6 seese-logo-actual';
  } elseif($logo_column === '5/6'){
    $logo_col_class = 'col-lg-10 col-md-10 col-sm-10 col-6 seese-logo-actual';
  } elseif($logo_column === '11/12'){
    $logo_col_class = 'col-lg-11 col-md-11 col-sm-11 col-6 seese-logo-actual';
  } elseif($logo_column === '12/12'){
    $logo_col_class = 'col-lg-12 col-md-12 col-sm-12 col-6 seese-logo-actual';
  } else {
    $logo_col_class = 'col-lg-2 col-md-2 col-sm-6 col-6 site-logo';
  }

  if($menu_column === '1/12'){
    $menu_col_class = 'col-lg-1 col-md-1 col-sm-1 col-6 seese-menu-actual';
  } elseif($menu_column === '1/5'){
    $menu_col_class = 'col-lg-2 col-md-2 col-sm-2 col-6 seese-menu-actual';
  } elseif($menu_column === '1/4'){
    $menu_col_class = 'col-lg-3 col-md-3 col-sm-3 col-6 seese-menu-actual';
  } elseif($menu_column === '1/3'){
    $menu_col_class = 'col-lg-4 col-md-4 col-sm-4 col-6 seese-menu-actual';
  } elseif($menu_column === '5/12'){
    $menu_col_class = 'col-lg-5 col-md-5 col-sm-5 col-6 seese-menu-actual';
  } elseif($menu_column === '1/2'){
    $menu_col_class = 'col-lg-6 col-md-6 col-sm-6 col-6 seese-menu-actual';
  } elseif($menu_column === '7/12'){
    $menu_col_class = 'col-lg-7 col-md-7 col-sm-7 col-6 seese-menu-actual';
  } elseif($menu_column === '2/3'){
    $menu_col_class = 'col-lg-8 col-md-8 col-sm-8 col-6 seese-menu-actual';
  } elseif($menu_column === '3/4'){
    $menu_col_class = 'col-lg-9 col-md-9 col-sm-9 col-6 seese-menu-actual';
  } elseif($menu_column === '5/6'){
    $menu_col_class = 'col-lg-10 col-md-10 col-sm-10 col-6 seese-menu-actual';
  } elseif($menu_column === '11/12'){
    $menu_col_class = 'col-lg-11 col-md-11 col-sm-11 col-6 seese-menu-actual';
  } elseif($menu_column === '12/12'){
    $menu_col_class = 'col-lg-12 col-md-12 col-sm-12 col-6 seese-menu-actual';
  } else {
    $menu_col_class = 'col-lg-8 col-md-8 col-sm-8 col-6 site-menu';
  }

  if($right_icon_column === '1/12'){
    $icon_col_class = 'col-lg-1 col-md-1 col-sm-1 col-6 seese-icon-actual';
  } elseif($right_icon_column === '1/5'){
    $icon_col_class = 'col-lg-2 col-md-2 col-sm-6 col-6 seese-icon-actual';
  } elseif($right_icon_column === '1/4'){
    $icon_col_class = 'col-lg-3 col-md-3 col-sm-6 col-6 seese-icon-actual';
  } elseif($right_icon_column === '1/3'){
    $icon_col_class = 'col-lg-4 col-md-4 col-sm-6 col-6 seese-icon-actual';
  } elseif($right_icon_column === '5/12'){
    $icon_col_class = 'col-lg-5 col-md-5 col-sm-6 col-6 seese-icon-actual';
  } elseif($right_icon_column === '1/2'){
    $icon_col_class = 'col-lg-6 col-md-6 col-sm-6 col-6 seese-icon-actual';
  } elseif($right_icon_column === '7/12'){
    $icon_col_class = 'col-lg-7 col-md-7 col-sm-7 col-6 seese-icon-actual';
  } elseif($right_icon_column === '2/3'){
    $icon_col_class = 'col-lg-8 col-md-8 col-sm-8 col-6 seese-icon-actual';
  } elseif($right_icon_column === '3/4'){
    $icon_col_class = 'col-lg-9 col-md-9 col-sm-9 col-6 seese-icon-actual';
  } elseif($right_icon_column === '5/6'){
    $icon_col_class = 'col-lg-10 col-md-10 col-sm-10 col-6 seese-icon-actual';
  } elseif($right_icon_column === '11/12'){
    $icon_col_class = 'col-lg-11 col-md-11 col-sm-11 col-6 seese-icon-actual';
  } elseif($right_icon_column === '12/12'){
    $icon_col_class = 'col-lg-12 col-md-12 col-sm-12 col-6 seese-icon-actual';
  } else {
    $icon_col_class = 'col-lg-2 col-md-2 col-sm-6 col-6 site-header-icon';
  }
