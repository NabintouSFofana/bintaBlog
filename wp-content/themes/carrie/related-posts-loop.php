...
if ($tags) {
	...
	if( $my_query->have_posts() ) {
		...
		echo '<h5>'.esc_html__('You may also like','carrie').'</h5>';
		...
		<div class="blog-post-related-date"><i class="fa fa-calendar" aria-hidden="true"></i><?php echo get_the_time( get_option( 'date_format' ), get_the_ID() );?></div>
