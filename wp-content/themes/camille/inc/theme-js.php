<?php
	...
	add_action( 'wp_enqueue_scripts', 'camille_enqueue_dynamic_js', '999' );

	function camille_enqueue_dynamic_js( ) {
    ...
    $(document).ready(function() {
        ...
        <?php if(isset($camille_theme_options['custom_js_code'])) {

        	echo camille_wp_kses_data($camille_theme_options['custom_js_code']);  // This variable contains user Custom JS code and can't be escaped with WordPress functions
