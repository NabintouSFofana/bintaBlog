		...
		<div class="radium-importer-wrap" data-demo-id="1"  data-nonce="<?php echo wp_create_nonce('radium-demo-code'); ?>">
	    	...
	    	<div class="wrap vtdemo-one-click">
					...
					<div id="poststuff">
							...
							<div id="post-body-content">
								<div class="meta-box-sortables ui-sortable">
									...
									<div class="postbox">
										...
										<h3>
											<span><?php esc_attr_e( AILSA_NAME_P .' - One Click Install', 'vt_admin_text' ); ?></span>
	                    ...
	                    <a href="https://www.youtube.com/watch?v=qyrcSFI7hwQ" target="_blank" class="cs-section-video"><i class="fa fa-youtube-play"></i> <span>How to?</span></a>
		                </div>
							...
							<div class="meta-box-sortables">
								...
								<div class="postbox vt-support-box">
									...
									<div class="inside">
										...
										<a href="http://victorthemes.com/docs/ailsa" class="button-primary" target="_blank"><?php esc_attr_e('Docs', 'vt_admin_text'); ?></a>
										...
										<a href="http://victorthemes.com/wp-themes/ailsa" class="button-primary" target="_blank"><?php esc_attr_e('Item Page', 'vt_admin_text'); ?></a>
									</div>
									<!-- .inside -->
    ...
    <br /><?php
	    ...
	    public function set_demo_data( $file ) {
	        ...
	        if ( !class_exists( 'WP_Import' ) ) {
	            ...
	            $class_wp_import = AILSA_PLUGIN_INC . '/import/importer/wordpress-importer.php';
