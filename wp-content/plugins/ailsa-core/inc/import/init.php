...
if ( !class_exists( 'Radium_Theme_Demo_Data_Importer' ) ) {
	...
	require_once( AILSA_PLUGIN_INC . '/import/importer/radium-importer.php' ); //load admin theme data importer
	...
	class Radium_Theme_Demo_Data_Importer extends Radium_Theme_Importer {
		...
		public function __construct() {
			...
			$this->demo_files_path = AILSA_PLUGIN_INC . '/import/demo-files/'; // can
		...
		public function set_home_page(){
			...
			// Set the front page
			$homepage = get_page_by_title( 'Standard – With Sidebar' );
			if ( $homepage ) {
