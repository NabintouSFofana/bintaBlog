...
<?php } ?>
<div class="cfx_inline_content<?php echo $animation_class; ?>" id="crm_box_<?php echo $form_id ?>" style="display: none; overflow: visible;">
<?php
$close_btn_class='';
...
$fixed=apply_filters('crmperks_forms_new_submission_data',$fixed,$form); 
...
if(!in_array( strtolower($ext),$allowed_files)){
