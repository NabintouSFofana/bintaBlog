 ...
 if ( !class_exists( 'Radium_Theme_Importer' ) ) {
	...
	class Radium_Theme_Importer {
			...
			?>
			 ...
			 <div class="theme-demo-import-items">
				 ...
				 <div class="theme-demo-import-item">
					 ...
					 <a class="theme-live-preview button button-primary" href="http://wp.creanncy.com/carrie/carrie-1/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="2">Demo 2 - Magazine<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/2/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.creanncy.com/carrie/carrie-2/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 ...
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.creanncy.com/carrie/carrie-3/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="4">Demo 4 - Elegant<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/4/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.creanncy.com/carrie/carrie-4/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="5">Demo 5 - Vlog & Video<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/5/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.creanncy.com/carrie/carrie-5/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="6">Demo 6 - Advanced<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/6/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.creanncy.com/carrie/carrie-6/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="7">Demo 7 - Personal<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/7/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.creanncy.com/carrie/carrie-7/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="8">Demo 8 - Masonry<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/8/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.creanncy.com/carrie/carrie-8/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="9">Demo 9 - Carousel<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/9/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.creanncy.com/carrie/carrie-9/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="10">Demo 10 - Simple<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/10/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.creanncy.com/carrie/carrie-10/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="11">Demo 11 - Text<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/11/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.creanncy.com/carrie/carrie-11/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="12">Demo 12 - 3 columns<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/12/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.creanncy.com/carrie/carrie-12/" target="_blank">Live preview</a>
					 </div>
				 </div>
	    ...
	    public function demo_installer() {
	        ...
	        <h2>One Click Carrie Theme Demo Data import</h2>
			<script>
			(function($){
			$(document).ready(function() {
				...
				$("body").on( "click", ".check-import-log", function() {
